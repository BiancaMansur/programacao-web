...
class CursoController {
    ...
    // Cria um curso (Operação agora transacional no Service)
    ...
    // Atualiza um curso (Operação agora transacional no Service)
    ...
    // Remove um curso (Operação agora transacional no Service)
