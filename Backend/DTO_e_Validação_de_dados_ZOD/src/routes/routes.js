...
// Importando os validadores padronizados (ZOD)
const { validateAluno, validateCurso, validateMatricula } = require('../validators/alunoZodValidator');

// ALUNO
router.get('/alunos', (req, res) => AlunoController.getAll(req, res));
router.get('/alunos/:id', (req, res) => AlunoController.getById(req, res));
router.post('/alunos', validateAluno, (req, res) => AlunoController.create(req, res));
...
router.post('/cursos', validateCurso, (req, res) => CursoController.create(req, res));
...
router.post('/matriculas', validateMatricula, (req, res) => MatriculaController.create(req, res));
