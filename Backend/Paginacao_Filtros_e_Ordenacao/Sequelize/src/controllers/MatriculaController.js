...
class MatriculaController {
    ...
    // Lista todas as matriculas paginação, filtros e ordenação
    async getAll(req, res) {
        // Passa os parâmetros da query para o serviço processar
        const dados = await MatriculaService.listarTodas(req.query);
