...
export class EscolaController {
    ...
    // Listar todos os alunos com suporte a paginação, filtros e ordenação
    async getAllAlunos(req: Request, res: Response) { 
        // Repassa os parâmetros da query para o serviço processar
        res.json(await service.listarAlunos(req.query)); 
    }
    ...
    // Listar todos os cursos com suporte a paginação, filtros e ordenação
    async getAllCursos(req: Request, res: Response) { 
        // Repassa os parâmetros da query para o serviço processar
        res.json(await service.listarCursos(req.query)); 
    }
    ...
    // Listar todas as matrículas com suporte a paginação, filtros e ordenação
    async getAllMatriculas(req: Request, res: Response) { 
        // Repassa os parâmetros da query para o serviço processar
        res.json(await service.listMatriculas(req.query)); 
    }
